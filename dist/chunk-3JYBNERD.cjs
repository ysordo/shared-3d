...
var AdvancedOrbitControls = ({
  ...
  const state = _react.useMemo.call(void 0, 
    () => ({
      enablePan: _nullishCoalesce(_optionalChain([plugin, 'optionalAccess', _3 => _3.enablePan]), () => ( enablePan)),
      enableRotate: _nullishCoalesce(_optionalChain([plugin, 'optionalAccess', _4 => _4.enableRotate]), () => ( enableRotate)),
      enableZoom: _nullishCoalesce(_optionalChain([plugin, 'optionalAccess', _5 => _5.enableZoom]), () => ( enableZoom)),
      minDistance: _nullishCoalesce(_optionalChain([plugin, 'optionalAccess', _6 => _6.minDistance]), () => ( minDistance)),
      maxDistance: _nullishCoalesce(_optionalChain([plugin, 'optionalAccess', _7 => _7.maxDistance]), () => ( maxDistance)),
      setEnablePan,
      setEnableRotate,
      setEnableZoom,
      setMinDistance,
