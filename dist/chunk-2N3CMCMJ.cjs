...
var GLTFLoader2 = (_class = class {
  ...
  static async load(entry, options = {}) {
    ...
    const cached = await _chunkV5RHI4ROcjs.ObjectCache.get(id);
      ...
      loader.load(
        ...
        async (gltf) => {
          try {
            ...
            await _chunkV5RHI4ROcjs.ObjectCache.set(id, scene, hash);
  ...
  static async invalidate(id) {
    await _chunkV5RHI4ROcjs.ObjectCache.delete(id);
  }
  static async clearCache() {
    await _chunkV5RHI4ROcjs.ObjectCache.clearAll();
  }
