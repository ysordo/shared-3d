...
var AdvancedOrbitControls = ({
  ...
  const factory = _react.useCallback.call(void 0, () => new (0, _chunkLZBVRCLFcjs.AdvancedOrbitControlsPlugin)(), []);
  const plugin = _chunkLLUDUZX2cjs.usePlugin.call(void 0, factory, config);
