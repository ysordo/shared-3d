"use strict";Object.defineProperty(exports, "__esModule", {value: true});// src/core/plugins/postprocessing/ureal-engine/VelocityShader.ts
var VelocityShader = {
  uniforms: {
...
exports.VelocityShader = VelocityShader;
