...
var AOPlugin = (_class = class {
  ...
  install({ camera, scene }) {
    this.effect = new (0, _n8ao.N8AOPostPass)(scene, camera, this.config.width, this.config.height);
    ...
    this.effect.configuration.color = new _chunkEA3XQ4KJcjs.THREE.Color(0, 0, 0);
