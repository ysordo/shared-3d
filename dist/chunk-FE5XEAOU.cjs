...
var Canvas = _react.forwardRef.call(void 0, 
  ({ config, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _jsxruntime.Fragment, { children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _chunkEUGK72HYcjs.SceneProvider, { ref: canvasRef, config, children: [
