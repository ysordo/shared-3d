...
var AdvancedDragRaycaster = ({
  ...
  const factory = _react.useCallback.call(void 0, () => {
    ...
    return new (0, _chunkHPHYHDPRcjs.AdvancedRaycasterPlugin)(model, eventHandler);
  }, [model, eventHandler]);
  const plugin = _chunkN4YA2OBNcjs.usePlugin.call(void 0, factory, [model, eventHandler]);
  _react.useEffect.call(void 0, () => {
    if (_optionalChain([plugin, 'optionalAccess', _4 => _4.manager])) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _jsxruntime.Fragment, { children: _optionalChain([children, 'optionalCall', _5 => _5(controlState)]) });
};
