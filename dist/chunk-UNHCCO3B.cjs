...
var _chunkYHVVAPCFcjs = require('./chunk-YHVVAPCF.cjs');
...
var AdvancedDragRaycaster = ({
  ...
  const { camera } = _chunkGMH5GOKAcjs.useScene.call(void 0, );
  const model = _chunkI6WKSXUGcjs.useActiveModel.call(void 0, );
