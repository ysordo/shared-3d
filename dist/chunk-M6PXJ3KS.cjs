...
var usePlugin = (factory, config, deps = []) => {
  ...
  _react.useEffect.call(void 0, () => {
    ...
    if (shouldRecreate) {
      ...
      _optionalChain([pluginRef, 'access', _7 => _7.current, 'access', _8 => _8.update, 'optionalCall', _9 => _9(config)]);
    }
    return () => {
      if (pluginRef.current) {
        orchestrator.remove(pluginRef.current.name);
        _optionalChain([pluginRef, 'access', _10 => _10.current, 'access', _11 => _11.dispose, 'optionalCall', _12 => _12()]);
