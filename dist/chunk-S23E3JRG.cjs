...
// src/core/plugins/postprocessing/BloomPostProcessingPlugin.ts
...
var BloomPostProcessingPlugin = (_class = class {
  __init() {this.name = "BloomPostProcessing"}
...
exports.BloomPostProcessingPlugin = BloomPostProcessingPlugin;
