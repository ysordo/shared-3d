...
var _chunkWLKXVYWGcjs = require('./chunk-WLKXVYWG.cjs');
...
var AdvancedDragRaycaster = ({
  ...
  const { camera } = _chunkJEORJOC4cjs.useScene.call(void 0, );
  ...
  const plugin = _chunkWLKXVYWGcjs.usePlugin.call(void 0, factory, config);
