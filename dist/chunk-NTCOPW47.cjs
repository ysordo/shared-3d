...
var MeasurementToolPlugin = (_class = class {
  ...
  __init5() {this.raycaster = new _chunkEA3XQ4KJcjs.THREE.Raycaster()}
  __init6() {this.pointer = new _chunkEA3XQ4KJcjs.THREE.Vector2()}
  constructor(config) {;_class.prototype.__init.call(this);_class.prototype.__init2.call(this);_class.prototype.__init3.call(this);_class.prototype.__init4.call(this);_class.prototype.__init5.call(this);_class.prototype.__init6.call(this);
    this.config = {
      enabled: true,
      pointRadius: 0.05,
      color: 65280,
  ...
  spawnPoint(point) {
    const geometry = new _chunkEA3XQ4KJcjs.THREE.SphereGeometry(this.config.pointRadius, 16, 16);
    const material = new _chunkEA3XQ4KJcjs.THREE.MeshBasicMaterial({ color: this.config.color });
