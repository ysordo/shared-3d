...
export const AdvancedDragRaycaster = ({ children, defaultEnabled = true, enableRotationCompensation = true, transitionDuration = 0, onDragStart, onDrag, onDragEnd, }) => {
            ...
            switch (event.type) {
                ...
                case 'objectdrag':
                    if (isDragging && currentObject) {
                        ...
                        tempVector2_1.set((event.currentPosition.x / window.innerWidth) * 2 - 1, -(event.currentPosition.y / window.innerHeight) * 2 + 1);
                        tempVector2_2.set((startPosition.x / window.innerWidth) * 2 - 1, -(startPosition.y / window.innerHeight) * 2 + 1);
...
//# sourceMappingURL=AdvancedDragRaycaster.js.map