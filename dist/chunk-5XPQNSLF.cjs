...
var AdvancedOrbitControls = ({
  ...
  const factory = _react.useCallback.call(void 0, () => new (0, _chunkYMCE62ACcjs.AdvancedOrbitControlsPlugin)(), []);
  const plugin = _chunkOJGD2LZBcjs.usePlugin.call(void 0, factory, config);
