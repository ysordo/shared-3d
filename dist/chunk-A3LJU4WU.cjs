...
var _chunkD643RI6Scjs = require('./chunk-D643RI6S.cjs');
...
var AdvancedDragRaycaster = ({
  ...
  const { camera } = _chunk46M3FRLEcjs.useScene.call(void 0, );
  const model = _chunkD643RI6Scjs.useActiveModel.call(void 0, );
  ...
  const plugin = _chunkM5INMQVJcjs.usePlugin.call(void 0, factory, config);
