...
var SuspenseModel = ({
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkW2T32FMRcjs.Suspense, { fallback, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkXVSETJC7cjs.Model, { entry, draco, children: (model) => _optionalChain([children, 'optionalCall', _ => _(model)]) }) });
};
