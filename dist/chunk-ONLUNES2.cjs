...
var _chunk5EGAU3PJcjs = require('./chunk-5EGAU3PJ.cjs');
...
var AdvancedDragRaycaster = ({
  ...
  const { camera } = _chunkNJFICWZPcjs.useScene.call(void 0, );
  ...
  const plugin = _chunk5EGAU3PJcjs.usePlugin.call(void 0, factory, config);
