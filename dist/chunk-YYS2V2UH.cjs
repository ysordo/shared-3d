...
var SceneProvider = _react.forwardRef.call(void 0, 
  ({ children, config, canvasRef }, forwardedRef) => {
    ...
    const canvas = (_nullishCoalesce(canvasRef, () => ( internalCanvasRef))).current;
    ...
    return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, SceneContext.Provider, { value, children: [
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "canvas", { ref: _nullishCoalesce(forwardedRef, () => ( internalCanvasRef)) }),
      children
    ] });
  }
);
