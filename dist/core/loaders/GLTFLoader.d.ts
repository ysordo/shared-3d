...
declare class GLTFLoader {
    ...
    static preload(entries: ModelManifest, options?: GLTFLoaderOptions, onProgress?: (obj: THREE.Group, entry: ManifestEntry, completed: number, total: number) => void): Promise<void>;
