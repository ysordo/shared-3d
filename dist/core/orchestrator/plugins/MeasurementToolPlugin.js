...
export class MeasurementToolPlugin {
    ...
    install({ scene, camera, renderer, orchestrator }) {
        const handlePointerDown = (e) => {
            ...
            const sphere = new THREE.Mesh(new THREE.SphereGeometry(0.05), new THREE.MeshBasicMaterial({ color: 0x00ff00 }));
...
//# sourceMappingURL=MeasurementToolPlugin.js.map