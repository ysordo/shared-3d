...
export class AdvancedCameraCollisionPlugin {
    distanceThreshold;
    pushBackOffset;
    ...
    install({ camera, orchestrator }) {
        ...
        const check = () => {
            ...
            const ray = new THREE.Raycaster(camera.position, dir, 0, this.distanceThreshold + this.pushBackOffset);
...
//# sourceMappingURL=AdvancedCameraCollisionPlugin.js.map