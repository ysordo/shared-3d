...
var AdvancedOrbitControlsPlugin = (_class = class {
  ...
  install({ camera, renderer }) {
    ...
    this.controls.enablePan = _nullishCoalesce(this.config.enablePan, () => ( true));
    this.controls.enableRotate = _nullishCoalesce(this.config.enableRotate, () => ( true));
    this.controls.enableZoom = _nullishCoalesce(this.config.enableZoom, () => ( true));
    const animate = () => {
