...
var _chunkFZYD35KXcjs = require('./chunk-FZYD35KX.cjs');
...
var AdvancedRaycaster = ({
  ...
  const activeModel = _chunkFZYD35KXcjs.useActiveModel.call(void 0, );
  _react.useEffect.call(void 0, () => {
    const plugin = new (0, _chunkOIMHWLGOcjs.AdvancedRaycasterPlugin)(
