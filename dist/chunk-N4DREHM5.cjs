...
var HDRI = ({
  ...
  const orch = _chunkWAZQGQ6Zcjs.useScene.call(void 0, );
  ...
  _react.useEffect.call(void 0, () => {
    ...
    if (isHandle.current) {
      if (_optionalChain([orch, 'access', _6 => _6.activeHDRI, 'access', _7 => _7.get, 'call', _8 => _8(), 'optionalAccess', _9 => _9.name]) !== entry.id && !isloaded.current) {
