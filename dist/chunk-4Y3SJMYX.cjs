  ...
  ({ children, config }, ref) => {
    ...
    _react.useEffect.call(void 0, () => {
      ...
      setOrchestrator((prev) => {
        ...
        return _chunkTLB6VI3Wcjs.SceneOrchestrator.getInstance(_nullishCoalesce(ref.current, () => ( void 0)), config);
      });
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
      ...
      {
        value: { orchestrator, activeModel, preload: preload.current },
        children
      }
    );
  }
