...
var _chunkYXKWJ6GIcjs = require('./chunk-YXKWJ6GI.cjs');
...
var AdvancedDragRaycaster = ({
  ...
  const activeModel = _chunkYXKWJ6GIcjs.useActiveModel.call(void 0, );
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _jsxruntime.Fragment, { children: _optionalChain([children, 'optionalCall', _8 => _8({
    isEnabled,
    toggleEnabled,
    setEnabled,
    resetAll,
