...
var HDRI = ({
  ...
  const orch = _chunkMCFEPZPLcjs.useScene.call(void 0, );
  ...
  _react.useEffect.call(void 0, () => {
    ...
    if (isHandle.current) {
      if (_optionalChain([orch, 'access', _6 => _6.activeHDRI, 'access', _7 => _7.get, 'optionalAccess', _8 => _8.name]) !== entry.id && !isloaded.current) {
