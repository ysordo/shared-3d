...
import { HighResPostProcessingPlugin } from '../../../core/plugins/postprocessing/HighResPostProcessingPlugin';
 ...
 * />
 */
export const HighResPostProcessing: React.FC<HighResPostProcessingProps> = ({
  enabled = true,
