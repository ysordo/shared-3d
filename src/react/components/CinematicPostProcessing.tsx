...
import { CinematicPostProcessingPlugin } from '../../core/plugins/CinematicPostProcessingPlugin';
 ...
 * />
 */
export const CinematicPostProcessing: React.FC<CinematicPostProcessingProps> = ({
  enabled = true,
